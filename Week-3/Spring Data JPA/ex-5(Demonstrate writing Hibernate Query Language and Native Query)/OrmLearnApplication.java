...
public class OrmLearnApplication {
    ...
    public static void main(String[] args) {
        ...
        testDepartmentEmployee(context);
    ...
    private static void testDepartmentEmployee(ApplicationContext context) {
        DepartmentService departmentService = context.getBean(DepartmentService.class);
        departmentService.displayDepartmentWithEmployees(); // NOT doing the loop here
    }
    private static void testSearchByNameJPQL() {
        LOGGER.info("JPQL Search Start");
        List<Country> countries = countryService.searchByNameJPQL("in");
        LOGGER.debug("JPQL Result: {}", countries);
        LOGGER.info("JPQL Search End");
    }

    private static void testSearchByNameNative() {
        LOGGER.info("Native SQL Search Start");
        List<Country> countries = countryService.searchByNameNative("in");
        LOGGER.debug("Native Result: {}", countries);
        LOGGER.info("Native SQL Search End");
    }
